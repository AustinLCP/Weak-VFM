...
obj365v1_train_dataset = dict(
    ...
    class_text_path='YOLO_World/data/texts/obj365v1_class_texts.json',
...
coco_val_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root='YOLO_World/data/coco/',
                 test_mode=True,
                 ann_file='lvis/lvis_v1_minival_inserted_image_name.json',
                 data_prefix=dict(img=''),
                 batch_shapes_cfg=None),
    class_text_path='YOLO_World/data/texts/lvis_v1_class_texts.json',
    pipeline=test_pipeline)
val_dataloader = dict(dataset=coco_val_dataset)
test_dataloader = val_dataloader

val_evaluator = dict(type='mmdet.LVISMetric',
                     ann_file='YOLO_World/data/coco/lvis/lvis_v1_minival_inserted_image_name.json',
                     metric='bbox')
