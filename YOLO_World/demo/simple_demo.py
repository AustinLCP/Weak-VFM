...
def inference(model, image, texts, test_pipeline, score_thr=0.5, max_dets=100):
...
if __name__ == "__main__":
    ...
    config_file = "YOLO_World/configs/pretrain/yolo_world_v2_x_vlpan_bn_2e-3_100e_4x8gpus_obj365v1_goldg_train_1280ft_lvis_minival.py"
    checkpoint = "YOLO_World/weights/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth"
    ...
    texts = [['car']]
    image = "data/kitti/KITTI3D/training/image_2/000142.png"
