...
kitti_raw_file_name = 'train_raw_sample.txt'
full_path_prefix = "E:\\Honours\\WeakM3D\\WeakM3D\\"
...
if __name__ == '__main__':
    ...
    for i, _ in enumerate(tqdm(img_list, desc="Projecting lidar points")):
        ...
        seg_mask_path = img_path.replace('image_02', 'langSAM_seg_mask').replace('png', 'npz')
        seg_bbox_path = img_path.replace('image_02', 'langSAM_seg_bbox').replace('png', 'txt')
        lidar_save_RoI_points_path = img_path.replace('image_02', 'langSAM_RoI_points').replace('png', 'pkl')
